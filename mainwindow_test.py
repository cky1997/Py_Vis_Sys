...
class MainWindow(QWidget, Ui_Form):
    def __init__(self, parent=None):
        ...
        # self.pushButton_6.connect(self.threadclass, QtCore.pyqtSignal('CPU_value'), self.updateProgressBar)
        # self.connect(self.threadclass, QtCore.pyqtSignal('CPU_value'), self.updateProgressBar)
        # self.threadclass.CPU_value.connect(self.updateProgressBar)
